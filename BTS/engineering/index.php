      ...
      <nav class="navbar navbar-expand-lg navbar-light py-0 ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item center-menu">
              <a class="nav-link active " href="">Engineering</a>
            </li>
      ...
      <div class="row announcement pt-5">
          ...
          <ul class="nav flex-column" style="margin-bottom: 15px;">
            <li class="nav-item">
             ...
             <?php 
                      ...
                      $sql="select *from news_and_event WHERE engineering=1 ORDER BY id DESC LIMIT 5";
        ...
        <div class="col-lg-4">
          <ul class="nav flex-column"  style="margin-bottom: 15px;">
            ...
            <?php                  
                      $sql="select *from notice WHERE engineering=1 ORDER BY id DESC LIMIT 5";
                      $query=mysqli_query($db,$sql);
                      while($row=mysqli_fetch_array($query))
                        {
              ?>
        ...
        <div class="col-lg-4">
          <ul class="nav flex-column">
            ...
            <?php                  
                      $sql="select *from calender WHERE engineering=1 ORDER BY id DESC LIMIT 2";
                      $query=mysqli_query($db,$sql);
                      while($row=mysqli_fetch_array($query))
                        {
              ?>
