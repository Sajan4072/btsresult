...
<?php  
    ...
    mysqli_query($db,"INSERT INTO engineering(firstname,lastname,address,fathername,faculty,phone,password,image, uniquecode,dob) VALUES('$fname', '$lname', '$address', '$fathername','$faculty', '$phone', '$password','$image','$uniquecode','$dob');"); 
