                ...
                <form class="form-inline my-2 my-lg-0">
                    <ul class="navbar-nav mr-lg-5">
                        <li class="nav-item dropdown">
                            <a class="nav-link right-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Login</a>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <?php 
                    ...
                    $show_drop_down=true;
                      ...
                      $sql1="select distinct class from school_result where uniquecode='$code'";
