      ...
      <nav class="navbar navbar-expand-lg navbar-light py-0 ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item center-menu">
              <a class="nav-link active" href="../results/results.html">Results</a>
            </li>
            <li class="nav-item center-menu">
...
<div class="container-fluid" >
  <div class="row" style="margin-top: 50px;">
    <div class="col-lg-6 col-md-6 col-sm-6">
      <h6 >NAME:<?php echo $_SESSION['login_user'];?></h6>
      <?php 
                      ...
                      $sql="select *from school_result where uniquecode='$code' LIMIT 1 ";
  ...
  <tbody>
     <?php 
                      ...
                      $sql="select *from school_result where uniquecode='$code' ";
                      $query=mysqli_query($db,$sql);
                      $n=1;
                      while($row=mysqli_fetch_array($query))
                        {
...
?>  
    ...
    <div class="col-lg-2 col-md-12 col-sm-12 termsection">
      <div class="container-fluid">
        <div class="termslist ">
        <div class="row title"><h4>TERMS</h4></div>
        <div class="row "><a href="#">First term </a></div>
        <div class="row "><a href="#">Second term</a></div>
        <div class="row "><a href="#">Third term</a></div>
        <div class="row "><a href="#">Forth  term</a></div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-5 col-md-5 col-sm-12">
        <h6>TOTAL OPERATING DAYS:120</h6>
        <h6>TOTAL ATTENDANCE DAYS:118</h6>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12">
        <h6>PERCENTAGE:60%</h6>
