...
$fname = $lname = $address = $contact = $email = $password = "";  
...
<?php  
    if(isset($_POST['submit'])) {  
       ...
       $count=0;
        ...
        $sql="SELECT email from `school_teacher`";
    ...
    mysqli_query($db,"INSERT INTO school_teacher(firstname,lastname,address,email,contact,password) VALUES('$fname', '$lname', '$address', '$email', $contact, '$password');"); 
